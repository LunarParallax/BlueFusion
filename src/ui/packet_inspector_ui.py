...
class PacketInspectorUI:
    ...
    def get_inspection_summary(self, inspection_result: Dict[str, Any]) -> str:
        ...
        # Header
        lines.append("**Packet Inspector Report**")
    ...
    def get_security_statistics(self) -> pd.DataFrame:
        ...
        security_data = [
            {
                "Security Event": "Encrypted Packets",
                "Count": security_stats.get("encrypted", 0),
            },
            {
                "Security Event": "Authenticated",
                "Count": security_stats.get("authenticated", 0),
            },
            {
                "Security Event": "Pairing Requests",
                "Count": security_stats.get("pairing_requests", 0),
            },
            {
                "Security Event": "Total Warnings",
                "Count": stats.get("warnings_count", 0),
            },
        ]
