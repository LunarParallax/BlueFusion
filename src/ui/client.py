...
class BlueFusionClient:
    ...
    def discover_characteristics(
        ...
        try:
            response = self.client.get(
                f"{self.base_url}/devices/{address}/services/{service_uuid}/characteristics"
            )
            return response.json()
        except Exception as e:
            return {"error": str(e)}
    ...
    def discover_descriptors(self, address: str, char_uuid: str) -> Dict[str, Any]:
        ...
        try:
            response = self.client.get(
                f"{self.base_url}/devices/{address}/characteristics/{char_uuid}/descriptors"
            )
            return response.json()
        except Exception as e:
            return {"error": str(e)}
    ...
    def read_characteristic(self, address: str, char_uuid: str) -> Dict[str, Any]:
        ...
        try:
            response = self.client.get(
                f"{self.base_url}/devices/{address}/characteristics/{char_uuid}/read"
            )
            return response.json()
        except Exception as e:
            return {"error": str(e)}
    ...
    def write_characteristic(
        self, address: str, char_uuid: str, value: str, with_response: bool = True
    ) -> Dict[str, Any]:
